...
/** @type {string} */
const CACHE_VERSION = '1784450076|397978947';
/** @type {string} */
const CACHE_PREFIX = 'PixelPen-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libpixelpen.web.release.wasm32.wasm"];
